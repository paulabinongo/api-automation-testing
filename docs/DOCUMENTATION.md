...
| ----- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **1** | Eligibility & Pre-Qualification | **`evaluateHomeLoanEligibility`**, **`validateHomeLoanIntakeShape`** (citizenship **FILIPINO** \| **FOREIGNER_PERMANENT_RESIDENT**, age **21–65** at application, maturity **≤70**, income **≥ PHP 40k**/month family, tenure / OFW rules) |
